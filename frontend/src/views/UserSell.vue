<template>
  <div class="user-sell-page">
    ...
    <div class="page-header">
      ...
      <p class="page-subtitle">查看您作为卖家的所有订单</p>
    </div>
    ...
    <div class="order-list" v-loading="loading">
      ...
      >
          ...
          <div class="buyer-section">
            <div class="buyer-info">
              <div class="buyer-header">
                ...
                <span class="buyer-label">买家信息</span>
              </div>
              <div class="buyer-details">
                <div class="buyer-item">
                  <span class="label">姓名：</span>
                  <span class="value">{{ order.ownName || order.buyerName || '未知' }}</span>
                </div>
                <div class="buyer-item" v-if="order.phone">
                  <span class="label">手机：</span>
                  <span class="value">{{ order.phone }}</span>
                </div>
                <div class="buyer-item" v-if="order.address">
          ...
          <div class="order-right">
            <div class="price-section">
              <div class="price-item">
                ...
                <span class="value">￥{{ formatPrice(order.uninPricee || order.price || order.totalPrice) }}</span>
              </div>
        ...
        <!-- 更新时间 -->
        <div class="order-footer" v-if="order.updateTime">
          <i class="el-icon-time"></i>
          <span>更新时间：{{ formatDate(order.updateTime) }}</span>
        </div>
      </div>
    </div>
...
export default {
    ...
    filteredOrders() {
      ...
      if (this.searchKeyword) {
        ...
        orders = orders.filter(order => {
          ...
          const buyerName = (order.ownName || order.buyerName || '').toLowerCase();
          return orderId.includes(keyword) || productName.includes(keyword) || buyerName.includes(keyword);
        });
      }
  ...
  methods: {
    ...
    calculateStatusCounts() {
      ...
      this.userSellList.forEach(order => {
        const status = order.status || order.type;
    ...
    confirmShip() {
      if (!this.shipForm.logisticsCompany || !this.shipForm.trackingNumber) {
    ...
    handleViewBuyer(order) {
      this.$message.info('跳转到联系买家页面');
      // TODO: 实现联系买家逻辑
    }
  }
};
